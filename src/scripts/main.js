...
const eventDate = new Date("Dec 12 2023 7:00:00");
...
const countHours = setInterval (function(){
    ...
    document.getElementById('counter').innerHTML = `The biggest technology event of Brazil starts in:<br> ${daysUntilEvent}d ${hoursUntilEvent}h ${minutesUntilEvent}m ${secondsUntilEvent}s`;
